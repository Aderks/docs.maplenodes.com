...
Oracler Miner offers a drop-in URL replacement to support the standard Ethereum JSON RPC interface.

Drop-in replacement: `https://api.oracleminer.com/xrs/eth_pass`

Ethereum nodes supported:

   * geth (archive node) - [Version](https://api.oracleminer.com/xrs/web3_clientVersion)

**NOTE:** Blocknet's CLI is not able to provide 'optional' parameter support yet. Please use the HTTP request method if 'optional' parameters are a requirement.
...
[eth_subscribe](#eth_subscribe)                                                     | Starts a subscription (on WebSockets / IPC / TCP transports) to a particular event. For every event that matches the subscription a JSON-RPC notification with event details and subscription ID will be sent to a client.
...
```shell
curl https://api.oracleminer.com/xrs/eth_pass \
    -X POST \
...
```plaintext
blocknet-cli xrService eth_accounts
```
...
```plaintext
{
    ...
    "jsonrpc" : "2.0",
    "id" : 1,
    "uuid" : "29586A51-8013-4FA1-ADBE-F0EC32CF9161"
}
```
...
```plaintext
blocknet-cli xrService eth_blockNumber
```
...
```plaintext
{
    ...
    "jsonrpc" : "2.0",
    "id" : 1,
    "uuid" : "39165E84-EEE9-442D-84D9-4EB05C18D470"
}
```
...
```plaintext
blocknet-cli xrService eth_call 0x407d73d8a49eeb85d32cf465507dd71d507100c1 0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b 0x76c0 0x9184e72a000 0x186a0 0xd46e8dd67c5d32be8d46e8dd67c5d32be8058bb8eb970870f072445675058bb8eb970870f072445675 latest
```
...
```plaintext
blocknet-cli xrService eth_chainId
```
...
```plaintext
blocknet-cli xrService eth_estimateGas 0x407d73d8a49eeb85d32cf465507dd71d507100c1 0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b 0x76c0 0x9184e72a000 0x186a0 0xd46e8dd67c5d32be8d46e8dd67c5d32be8058bb8eb970870f072445675058bb8eb970870f072445675
```
...
```plaintext
blocknet-cli xrService eth_gasPrice
```
<code class="api-call">eth_gasPrice</code>
...
```plaintext
{
    ...
    "jsonrpc" : "2.0",
    "id" : 1,
    "uuid" : "36103775-41D4-4EFA-8D74-36B21A8ACFB6"
}
```
...
```plaintext
blocknet-cli xrService eth_getBalance 0x407d73d8a49eeb85d32cf465507dd71d507100c1 latest
```
...
```plaintext
{
    ...
    "jsonrpc" : "2.0",
    "id" : 1,
    "uuid" : "D56E1369-D09D-4B3A-9D28-50B033CD3DE9"
}
```
...
```plaintext
blocknet-cli xrService eth_getBlockByHash 0x5bc28118ff3f15c4ae1cd14548c9a89c87405c5a9f0536c517f5955ace4b1011 false
```
...
```plaintext
{
    ...
    "jsonrpc" : "2.0",
    "id" : 1,
    "uuid" : "0D36E3F2-34CA-4BF3-B4A2-05259BDEB113"
}
```
...
```plaintext
blocknet-cli xrService eth_getBlockByNumber 0x899eef false
```
...
```plaintext
{
    ...
    "jsonrpc" : "2.0",
    "id" : 1,
    "uuid" : "376408BC-B7FB-411B-809F-9ED1214F7715"
}
```
...
```plaintext
blocknet-cli xrService eth_getBlockTransactionCountByHash 0x4faaf9dc3b7f58275d18d0d08a9c2aaf91c41102cfe915bbbd208506f1b85ebe
```
...
```plaintext
{
    ...
    "jsonrpc" : "2.0",
    "id" : 1,
    "uuid" : "953946D5-CC88-4E44-B6A0-15D525183B86"
}
```
...
```plaintext
blocknet-cli xrService eth_getBlockTransactionCountByNumber latest
```
...
```plaintext
{
    ...
    "jsonrpc" : "2.0",
    "id" : 1,
    "uuid" : "709741AE-1367-4470-9093-D3D41DACE08C"
}
```
...
```plaintext
blocknet-cli xrService eth_getCode 0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b latest
```
...
```plaintext
{
    ...
    "jsonrpc" : "2.0",
    "id" : 1,
    "uuid" : "BC1FA93E-0E33-492D-A3A8-D6D88243D435"
}
```
...
```plaintext
blocknet-cli xrService eth_getFilterChanges 0x16
```
...
```plaintext
blocknet-cli xrService eth_getFilterLogs 0x16
```
...
**Note:** This call is only supported by HTTP requests at the moment.
...
```plaintext
blocknet-cli xrService eth_getStorageAt 0x407d73d8a49eeb85d32cf465507dd71d507100c1 0x0 0x2
```
...
```plaintext
{
    ...
    "jsonrpc" : "2.0",
    "id" : 1,
    "uuid" : "5B0A6F85-DC8F-4C91-842C-5321C2A6D3E9"
}
```
...
```plaintext
blocknet-cli xrService eth_getTransactionByBlockHashAndIndex 0x4faaf9dc3b7f58275d18d0d08a9c2aaf91c41102cfe915bbbd208506f1b85ebe 0x0
```
...
```plaintext
{
    ...
    "jsonrpc" : "2.0",
    "id" : 1,
    "uuid" : "CCCC0A68-0A07-4070-B639-9323DEAC6E30"
}
```
...
```plaintext
blocknet-cli xrService eth_getTransactionByBlockNumberAndIndex latest 0x0
```
...
```plaintext
{
    ...
    "jsonrpc" : "2.0",
    "id" : 1,
    "uuid" : "6C6E0689-680E-4854-8080-FC1EF7AE57AD"
}
```
...
```plaintext
blocknet-cli xrService eth_getTransactionByHash 0x091e312f48b184fc86c1d14f6dac5ffad3e49e10752d59d4de4e87655d0156f4
```
...
```plaintext
{
    ...
    "jsonrpc" : "2.0",
    "id" : 1,
    "uuid" : "84D478F0-90E4-40CA-8467-12581BCC4233"
}
```
...
```plaintext
blocknet-cli xrService eth_getTransactionCount 0x407d73d8a49eeb85d32cf465507dd71d507100c1 latest
```
...
```plaintext
{
    ...
    "jsonrpc" : "2.0",
    "id" : 1,
    "uuid" : "9639A075-34FC-4D32-834F-D04BBB250E15"
}
```
...
```plaintext
blocknet-cli xrService eth_getTransactionReceipt 0x091e312f48b184fc86c1d14f6dac5ffad3e49e10752d59d4de4e87655d0156f4
```
...
```plaintext
{
    ...
    "jsonrpc" : "2.0",
    "id" : 1,
    "uuid" : "CAA851CD-B104-4A4E-9A7B-3DA949FFBAEA"
}
```
...
```plaintext
blocknet-cli xrService eth_getUncleByBlockHashAndIndex 0xb3b20624f8f0f86eb50dd04688409e5cea4bd02d700bf6e79e9384d47d6a5a35 0x0
```
...
```plaintext
{
  ...
  "jsonrpc": "2.0",
  "id": 1,
  "uuid": "C47CDE3F-6A95-4D39-A973-E54AD9AE7F28"
}
```
...
```plaintext
blocknet-cli xrService eth_getUncleByBlockNumberAndIndex 0x29c 0x0
```
...
```plaintext
{
  ...
  "jsonrpc": "2.0",
  "id": 1,
  "uuid": "9B531028-ED92-4588-8050-1D532017F999"
}
```
...
```plaintext
blocknet-cli xrService eth_getUncleCountByBlockHash 0x4faaf9dc3b7f58275d18d0d08a9c2aaf91c41102cfe915bbbd208506f1b85ebe
```
<code class="api-call">eth_getUncleCountByBlockHash [block_hash]</code>
...
```plaintext
{
    ...
    "jsonrpc" : "2.0",
    "id" : 1,
    "uuid" : "6074E961-0BA7-401D-A45E-5CDF88504D3E"
}
```
...
```plaintext
blocknet-cli xrService eth_getUncleCountByBlockNumber latest
```
...
```plaintext
{
    ...
    "jsonrpc" : "2.0",
    "id" : 1,
    "uuid" : "A5BA4D39-E5A6-4185-88F2-0CD9642878EE"
}
```
...
```plaintext
blocknet-cli xrService eth_getWork
```
...
```plaintext
{
    ...
    "id" : 1,
    "uuid" : "830772DC-3A00-4395-89D6-F7A12191B31E"
}
```
...
```plaintext
blocknet-cli xrService eth_hashrate
```
...
```plaintext
{
    ...
    "jsonrpc" : "2.0",
    "id" : 1,
    "uuid" : "4C618F3D-0987-4017-B445-325CB6FF9708"
}
```
...
```plaintext
blocknet-cli xrService eth_mining
```
...
```plaintext
{
    ...
    "jsonrpc" : "2.0",
    "id" : 1,
    "uuid" : "B50D5E5F-A92B-4B7B-92F1-1BB885325207"
}
```
...
```plaintext
blocknet-cli xrService eth_newBlockFilter
```
...
```plaintext
{
    ...
    "jsonrpc" : "2.0",
    "id" : 1,
    "uuid" : "91B5A736-913A-4CDC-8C1A-834B04A0E17D"
}
```
...
```plaintext
blocknet-cli xrService eth_newFilter 0x1 0x2 0x8888f1f195afa192cfee860698584c030f4c9db1 0x000000000000000000000000a94f5374fce5edbc8e2a8697c15331677e6ebf0b
```
...
```plaintext
{
    ...
    "jsonrpc" : "2.0",
    "id" : 1,
    "uuid" : "0DF8B667-48EF-4453-A456-F20CC334AA58"
}
```
...
```plaintext
blocknet-cli xrService eth_newPendingTransactionFilter
```
...
```plaintext
{
    ...
    "jsonrpc" : "2.0",
    "id" : 1,
    "uuid" : "EBCC1196-2ED6-4ABB-A7A6-C0377278EED1"
}
```
...
```plaintext
blocknet-cli xrService eth_protocolVersion
```
...
```plaintext
{
    ...
    "jsonrpc" : "2.0",
    "id" : 1,
    "uuid" : "BFED3848-4F7D-43C0-AC24-998BF21062DA"
}
```
...
```plaintext
blocknet-cli xrService eth_sendRawTransaction 0xf86c8085098bca5a008307a1209437ede5f23cdcecfba18331126668ef705ea78489872386f26fc100008025a04058f161da3a3b028d2a0cbb98f3d22045f97a41150506cb9a52cbf0238622e8a077b6880c0d4c2c1c4ebe23c51d86954aebafaa766cd38806d299997f3face0dd
```
...
```plaintext
{
    ...
    "jsonrpc" : "2.0",
    "id" : 1,
    "uuid" : "E6652F87-140D-4B83-BA0F-CF4EC7C4C7EF"
}
```
...
```plaintext
blocknetdx-cli xrService eth_submitWork 0x0000000000000001 0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef 0xD1FE5700000000000000000000000000D1FE5700000000000000000000000000
```
...
{  
    ...
    "jsonrpc" : "2.0",
    "id" : 1,
    "uuid" : "9FDD26CA-14A2-48E4-A511-8D49BCBD87D7"
}
```
...
```plaintext
blocknet-cli xrService eth_subscribe [param]
```
...
```plaintext
blocknet-cli xrService eth_syncing
```
...
```plaintext
{
    ...
    "jsonrpc" : "2.0",
    "id" : 1,
    "uuid" : "00AB1A87-B10B-42E4-B554-17E1D3026558"
}
```
...
```plaintext
blocknet-cli xrService eth_uninstallFilter 0x1
```
...
```plaintext
{
    ...
    "jsonrpc" : "2.0",
    "id" : 1,
    "uuid" : "3CFAE697-B838-4C95-B570-3ECA413767AC"
}
```
...
```plaintext
blocknet-cli xrService eth_unsubscribe 0xb53c4832f1dca4a5
```
...
```plaintext
{
    ...
    "jsonrpc" : "2.0",
    "id" : 1,
    "uuid" : "1288B2DB-EBBE-4029-AA30-98AED21A26BE"
}
```
...
```plaintext
blocknet-cli xrService net_listening
```
...
```plaintext
{
    ...
    "jsonrpc" : "2.0",
    "id" : 1,
    "uuid" : "A222A7D0-5F5F-452E-8B0A-A6A0CE3FC12D"
}
```
...
```plaintext
blocknet-cli xrService net_peerCount
```
...
```plaintext
{
    ...
    "jsonrpc" : "2.0",
    "id" : 1,
    "uuid" : "D8BF4510-DA68-447B-BB52-D69BFB3265C6"
}
```
...
```plaintext
blocknet-cli xrService net_version
```
...
```plaintext
{
    ...
    "jsonrpc" : "2.0",
    "id" : 1,
    "uuid" : "0BC02695-56E7-4E4F-8EAC-273EAE304671"
}
```
...
```plaintext
blocknet-cli xrService web3_clientVersion
```
...
```plaintext
{
    "reply" : "Geth/v1.9.23-stable-8c2f2715/linux-amd64/go1.15.3",
    "jsonrpc" : "2.0",
    "id" : 1,
    "uuid" : "A63C2EE5-9640-4836-BF59-03C2E92A97B8"
}
```
...
```plaintext
blocknet-cli xrService web3_sha3 0x68656c6c6f20776f726c64
```
...
```plaintext
{
    ...
    "jsonrpc" : "2.0",
    "id" : 1,
    "uuid" : "98D1D5ED-FD68-406E-825C-C2AD1700C637"
}
```
